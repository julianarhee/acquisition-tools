...
parser.add_option('--output-path', action="store", dest="output_path", default="/Users/julianarhee/Documents/MWorks/PyData/", help="out path directory [default: ~/Documents/MWorks/PyData]")
